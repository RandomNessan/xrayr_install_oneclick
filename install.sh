...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        last_version="xrayr-modi"
        echo -e "检测到 XrayR 版本：${last_version}，开始安装"
        wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip \
        https://github.com/RandomNessan/XrayR/releases/download/${last_version}/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        url="https://github.com/RandomNessan/XrayR/releases/download/${last_version}/XrayR-linux-${arch}.zip"
    ...
    file="https://github.com/RandomNessan/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/RandomNessan/xrayr_install_oneclick/main/XrayR.sh
